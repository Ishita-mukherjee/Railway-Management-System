    ...
    <div class="container">
      <div id="credit-card">
        <div id="credit-card-body">
          <div id="card-front">
            <img src="14.jpg" alt="visa card" class="card-logo" style="height: 50px;" />
            <div class="card-chip">
          ...
          <div id="card-back">
            ...
            <div id="card_cvv"></div>
            <div id="disclaimer">
              Security codes might be referred to as CVV, CVV2, CVC, CSC, CID, or other similar names. Most websites just ask for a “security code” and provide a small box for you to type the code into. On Visa, MasterCard, and Discover cards, the code is a three-digit code on the back of your card. 
            </div>
          </div>
        </div>
      </div>
      <form action="card.php" id="credit-card-form" method="post">
        <div class="form-group">
          ...
          <label for="card_cvv_input">Pay</label>
          <input type="submit" id="card_cvv_input" name="submit" value="Pay!" />
        </div>
      </form>
    </div>
  </div>
