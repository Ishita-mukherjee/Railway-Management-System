...
<body >
    <img src="e1.jpeg" alt="Snow" style="width:100%; -webkit-filter: blur(5px);filter: blur(5px);">
      <div class="top-left">
  <nav class="menu">
            <ul class="main-menu">
                <li><i class="fa fa-home"></i><a href="index.php" style="color: #8AF7EE;"> Home</a></li>
                <li><i class="fa fa-search"></i><a href="login.php" style="color: #8AF7EE;">User Login</a></li>
                <li ><i class="fa fa-briefcase"></i><a href="registration.php" style="color: #8AF7EE;"> Registration</a></li>
                <li class="active"><i class="fa fa-user"></i><a href="elogin.php"style="color: #8AF7EE;"> Employee Login</a></li>
        ...
        <div class="login-form">
          ...
          <form method="post" action="elogin_back.php">
