    ...
    <body style="background-image: linear-gradient(#B5F1EF,#93B8F0,#B5C6F1,#C6B5F1);">
        <nav class="menu">
            <ul class="main-menu">
                ...
                <li class="active"><i class="fa fa-search"></i> <a href="pnrcheck.php"> PNR Enquiry</a></li>
                <li><i class="fa fa-search"></i> <a href="Contact us.php"> Contact Us</a></li>
            </ul>
        </nav>
        <br><br><br><br>
    <div class="reg">
      <form method="post" action="pnr_back.php">
  <form>
  <table cellpadding="10">
    <tr>
      <td>  <h1 style="color: #243E7E; font-family: 'Roboto Slab', serif">PNR Enquiry</h1></td>
    </tr>
    <tr>
      <td style="font-family: 'Roboto Slab', serif;float: center">Enter PNR Number Below: <td>
    </tr>
    <tr>
      <td align="center"><input type="Number" name="pnr_n" placeholder="Enter PNR Number" class="in"> </td>
    </tr>
    <tr>
