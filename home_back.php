...
.t td
{
  font-size: 25px;
    ...
    <body style="background-image: linear-gradient(#EBF5FB,#ABEBC6,#117A65)">
        <nav class="menu">
            <ul class="main-menu">
        ...
        <br><br>
        <h2 align="center" style="font-size: 50px; color: #0E6655">Trains Available</h2>
<?php
...
if(isset($_POST['submit']))
{
    ...
    ?> <table cellpadding="10px" cellspacing="30px" align="center" style="text-align:center;border: 3px solid #0E6655; background-color: white;" class="t">
                <tr>
                    <th><u>Train ID</u></th>
                    <th><u>Train Name</u></th>
                    <th><u>Duration</u></th>
                    <th><u>Time</u></th>
                    <th><u>Source</u></th>
                    <th><u>Destination</u></th>
                    <th><u>Book Train</u></th>
                   </tr>
                ...
                <tr>
                    ...
                    $_SESSION['time']=$row['time'];?></td>
                    <td><?php echo $row['source'];?></td>
                    <td><?php echo $row['destination'];?></td>
                    <td><a class="button button1" href="test.php?tid=<?php echo($row['train_id']);?>"><font>Book</a></td></font>
                </tr>
                <?php endwhile;?>
            </table>
            <?php
    ...
    ?> <table cellpadding="10px" cellspacing="30px" align="center" style="text-align:center;border: 3px solid #0E6655; background-color: white;" class="t">
                ...
                <tr>
                    ...
                    <td><?php echo $row['source'];?></td>
                    <td><?php echo $row['destination'];?></td>
                    <td><a class="button button1" href="test.php?tid=<?php echo($row['train_id']);?>"><font>Book</font></a></td>
