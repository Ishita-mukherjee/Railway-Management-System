	...
	<nav class="menu">
            <ul class="main-menu">
                ...
                <li class="with-submenu">
                    <i class="fa fa-briefcase"></i>Reservation <i class="fa fa-caret-down"></i>
                    <ul class="submenu">
                        <li>Find Train</li>
                        <li>PNR Enquiry</li>
                ...
                <li><i class="fa fa-user"></i>Stays</li>
                <li><i class="fa fa-search"></i>Employee Login</li>
                <li><i class="fa fa-search"></i>Contact Us</li>
            </ul>
        </nav>
	<div class="container">
